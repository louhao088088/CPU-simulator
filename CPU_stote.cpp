  ...
  private:
    ...
    void decode_and_execute(uint32_t instruction, uint32_t &next_pc) {
        ...
        case 0b0000011: {
            ...
            if (funct3 == 0b000) {
                uint32_t address = cpu.regs[rs1] + offset;
                ...
                if (rd != 0)
                    cpu.regs[rd] = cpu.memory[address] | (cpu.memory[address + 1] << 8) |
        ...
        case 0b0010011: {
            ...
            if (funct3 == 0b000) {
                ...
                std::cerr << "Error: Unknown I-type instruction " << std::hex << instruction
                          << " at pc " << cpu.pc << std::endl;
                std::cerr << funct3 << " " << (instruction >> 26) << std::endl;
                is_halted = true;
            }
